...
# Config
# -----------------------------
EMBED_MODEL = "all-MiniLM-L6-v2"  # Local model name (used in sentence-transformers)
...
embed_model = SentenceTransformer(EMBED_MODEL)  # NEW: Load local embedding model
...
print("API KEY IN USE:", config.OPENAI_API_KEY)
